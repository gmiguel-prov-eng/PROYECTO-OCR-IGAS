...
from application.use_cases.flujo_caja_fichas.separar_pdf import ejecutar
...
def main():
    parser = argparse.ArgumentParser(description="Ejecuta el proceso 1: separacion PDF.")
    ...
    logger = configurar_logger("01_separacion_pdf", config["paths"]["logs"])
